...
def flist_creator(path):
    '''
    This function creates a flie list from a given folder.
...
def generate_irregular_masks(H, W,NumOutputMasks):
    """
    This function generates irregular masks of random shape and size.
